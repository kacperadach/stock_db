...
class FinvizScraper(BaseScraper):
    ...
    def get_symbols(self):
        return self.db.find(SYMBOL_COLLECTION, {'country_code': 'US', 'instrument_type': {'$in': ['stocks', 'exchange-traded-funds']}, 'symbol': {'$gt': 'SLB'}}, {'symbol': 1, 'instrument_type': 1, 'exchange': 1, 'country': 1, 'country_code': 1})
